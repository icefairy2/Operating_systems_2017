...
A2_DATA = ""
A2_PROG = "a2"
...
def checkThreads3(data, infos):
    ...
    if info1.timeEnd < thInfos[thAfter].timeStart:
        ...
        errors.append("thread T%d.%d ends before T%d.%d started" % (proc1, proc1Th, procNr, thAfter))
    if score == 3:
        score = 5
